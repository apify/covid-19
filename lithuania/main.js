...
Apify.main(async () => {
    ...
    const infected = $('#module_Structure > div > div.main_content.clearfix > div:nth-child(3) > div.text > ul:nth-child(6) > li:nth-child(1) > span > span > span > b').text()
    ...
    const result = {
        ...
        isolated: isolated,
        connectedDeaths: connectedDeaths,
