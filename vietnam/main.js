...
Apify.main(async () => {
    ...
    const crawler = new Apify.CheerioCrawler({
        ...
        handlePageFunction: async ({ request, $ }) => {
            ...
            const died = $('#portlet_corona_trangchu_top_CoronaTrangchuTopPortlet_INSTANCE_RrVAbIFIPL7v > div > div.portlet-content-container > div > section.container > div:nth-child(2) > div:nth-child(2) > div > div.col-lg-12.d-none.d-lg-block > div > div:nth-child(2) > div.col.text-center.text-uppercase.text-danger-new1 > span').text().trim().replace('.','');
